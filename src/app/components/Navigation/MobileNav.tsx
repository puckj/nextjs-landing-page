...
const MobileNav = ({ displayNav, displayNavHandler }: Props) => {
  const navDisplayStyle = displayNav ? "translate-x-0" : "translate-x-[-100%]";
  return (
    <div
      className={`transform transition-all duration-500 fixed top-0 left-0 z-[200]
  h-[100vh] right-0 bottom-0 bg-[#6d096b] ${navDisplayStyle}`}
    >
      <XMarkIcon
